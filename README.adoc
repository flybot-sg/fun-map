...
image:https://github.com/flybot-sg/fun-map/actions/workflows/main.yml/badge.svg?branch=magic[CI,link=https://github.com/flybot-sg/fun-map/actions/workflows/main.yml]
